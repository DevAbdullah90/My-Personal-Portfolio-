                ...
                <FootFinal>
                    <FinalLeft>
                        <Paragraph>
                            ...
                            </HeroIcon> by Abdullah
                        </Paragraph>
                    </FinalLeft>
                    <FinalRight>
                        <a href='mailto:devabdulah91@gmail.com' target="_blank" rel="noopener noreferrer">
                        ...
                        <a href='https://www.linkedin.com/in/abdullah-kashif-6961a931b/' target="_blank" rel="noopener noreferrer">
                            <Paragraph style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                        ...
                        <a href='https://github.com/DevAbdullah90' target="_blank" rel="noopener noreferrer">
                            <Paragraph style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
